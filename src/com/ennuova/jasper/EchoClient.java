...
public class EchoClient implements ApiClientConstant {
    ...
    private SOAPMessage createEchoRequest() throws SOAPException {
        ...
        //TODO ��Ҫ��api.10646.cn�޸�Ϊapi.jasperwireless.com
//        message.getMimeHeaders().addHeader("SOAPAction", "http://api.10646.cn/ws/service/echo/Echo");
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String[] a = {"a15c5134-e78c-4751-b29e-497c95fa4d4f"};
        String url = "https://api.10646.cn/ws/service/echo";
        @SuppressWarnings("unused")
		String ref = "https://api.10646.cn/ws/service/echo";
        if (a.length == 0) {
            System.out.println("usage: EchoClient <license-key>");
            System.exit(-1);
        }
        EchoClient echoClient = new EchoClient(url, a[0]);
