package com.ennuova.tools.wxpay.util;
...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxd930ea5d5a258f4f";//APP 唯一凭证
	public static String APP_SECRET = "db426a9829e4b49a0dcac7b4162da6b6";//应用密钥
	//应用对应的密钥
	...
	//package常量值
	public static String packageValue = "bank_type=WX&body=%B2%E2%CA%D4&fee_type=1&input_charset=GBK&notify_url=" +
			"http%3A%2F%2F127.0.0.1%3A8385%VehicleRepairingAPP%2FpayNotifyUrl.jsp&out_trade_no=2051571832&partner=1900000109&" +
