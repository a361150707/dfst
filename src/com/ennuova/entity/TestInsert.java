...
public class TestInsert implements java.io.Serializable {
	...
	@Id
	@SequenceGenerator(name="sequenceGenerator",sequenceName="SEQ_TEST_INSERT",allocationSize=1,initialValue=1)
