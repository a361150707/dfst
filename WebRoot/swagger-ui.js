...
(function() {
    ...
    templates['operation'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        buffer += escapeExpression(stack1) + "</a>\n                  </span>\n                </h3>\n      "+(depth0.updateTime?"<span style='float:right;margin:5px 20px 0 0;color:#aaa;"+(depth0.revisionHighlight?"color:red;":"")+"'>"+(depth0.reviser?depth0.reviser:"")+" 更新于："+depth0.updateTime+"</span>":"")+"        <ul style='float:left;margin-left:20px;' class='options'>\n                    <li>\n                        <a href='#!/";
        foundHelper = helpers.resourceName;
        stack1 = foundHelper || depth0.resourceName;
        if(typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {
        ...
        buffer += escapeExpression(stack1) + "_content' style='display:none'>\n    "+(depth0.description?"  <div style='font-size:14px;color:#10A54A;'>api 说明：</div><p style='margin-top:10px;padding:15px;background:#fff;'>"+depth0.description+"</p>       ":"")+(depth0.revisionDesc?"  <div style='margin-top:10px;font-size:14px;color:#10A54A;'>修订说明：</div><p style='margin-top:10px;padding:15px;background:#fff;'>"+depth0.revisionDesc+"</p>       ":"");   //新增说明
        foundHelper = helpers.notes;
        stack1 = foundHelper || depth0.notes;
        stack2 = helpers['if'];
...
(function() {
    ...
    templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
        ...
        buffer += escapeExpression(stack1) + "'>文档树</a>\n        </li>\n    </ul>\n</div>\n<ul class='endpoints' id='";
        foundHelper = helpers.name;
        stack1 = foundHelper || depth0.name;
        if(typeof stack1 === functionType) {
            stack1 = stack1.call(depth0, {
